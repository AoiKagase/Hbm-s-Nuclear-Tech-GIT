...
public class CraftingManager {
	...
	public static void addCircuitCrafting(){
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.PCB, 2), new Object[] { "I", "P", 'I', ModItems.plate_polymer, 'P', GOLD.plate() });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP, 2), new Object[] { "I", "S", "W", 'I', ModItems.plate_polymer, 'S', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.SILICON), 'W', GOLD.wire() });
	...
	public static void addRawFuelCrafting(){
        ...
        addShapelessAuto(new ItemStack(ModItems.nugget_pu_mix, 3), new Object[] { PU239.nugget(), PU239.nugget(), PU240.nugget() });
        ...
        addShapelessAuto(new ItemStack(ModItems.nugget_americium_fuel, 3), new Object[] { U238.nugget(), U238.nugget(), AMRG.nugget() });
	...
	public static void addRodCrafting(){
		...
		addShapelessAuto(new ItemStack(ModItems.nugget_euphemium, 1), new Object[] { ModItems.rod_quad_euphemium });
	}
	...
	public static void addPowderCrafting() {
        ...
        addShapelessAuto(new ItemStack(ModItems.powder_flux, 12), new Object[] { CA.dust(), KEY_SAND });
	...
	public static void addGearCrafting() {
		if(GeneralConfig.enableBabyMode) {
            ...
            addRecipeAuto(new ItemStack(ModItems.schrabidium_shield, 1), new Object[] { "IAI", "III", " I ", 'I', SA326.ingot(), 'A', DESH.ingot() });
			...
			addRecipeAuto(new ItemStack(ModItems.schrabidium_sword, 1), new Object[] { "I", "W", "S", 'I', SA326.block(), 'W', ModItems.starmetal_sword, 'S', POLYMER.ingot() });
            addRecipeAuto(new ItemStack(ModItems.schrabidium_shield, 1), new Object[] { "ISI", "IWI", "PIP", 'I', SA326.block(), 'W', ModItems.starmetal_shield, 'S', ModItems.pellet_charged, 'P', ModItems.powder_fire });
        ...
        addRecipeAuto(new ItemStack(ModItems.steel_shield, 1), new Object[] { "IAI", "III", " I ", 'I', STEEL.ingot(), 'A', IRON.ingot() });
        ...
        addRecipeAuto(new ItemStack(ModItems.titanium_shield, 1), new Object[] { "IAI", "III", " I ", 'I', TI.ingot(), 'A', IRON.ingot() });
        ...
        addRecipeAuto(new ItemStack(ModItems.cobalt_shield, 1), new Object[] { "IAI", "III", " I ", 'I', CO.ingot(), 'A', IRON.ingot() });
        ...
        addRecipeAuto(new ItemStack(ModItems.alloy_shield, 1), new Object[] { "IAI", "III", " I ", 'I', ALLOY.ingot(), 'A', IRON.ingot() });
        ...
        addRecipeAuto(new ItemStack(ModItems.cmb_shield, 1), new Object[] { "IAI", "III", " I ", 'I', CMB.ingot(), 'A', IRON.ingot() });
        ...
        addRecipeAuto(new ItemStack(ModItems.elec_shield, 1), new Object[] { "IAI", "IAI", "IAI", 'I', POLYMER.ingot(), 'A', "paneGlassColorless" });
        ...
        addRecipeAuto(new ItemStack(ModItems.desh_shield, 1), new Object[] { "IAI", "III", " I ", 'I', DESH.ingot(), 'A', POLYMER.ingot() });
		...
		addRecipeAuto(new ItemStack(ModItems.dns_helmet, 1), new Object[] { "PCP", "PBP", "PSP", 'P', ModItems.plate_armor_dnt, 'S', ModItems.ingot_chainsteel, 'B', ModItems.bj_helmet, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.QUANTUM) });
	...
	public static void addAmmoCrafting() {
		...
		addRecipeAuto(new ItemStack(ModItems.ammo_4gauge_slug, 12), new Object[] { " I ", "GCL", " P ", 'I', STEEL.ingot(), 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ANY_RUBBER.ingot() });
	...
	public static void addPartsCrafting() {
		...
		addShapelessAuto(new ItemStack(ModItems.fuse, 1), new Object[] { STEEL.plate(), ModItems.plate_polymer, W.wire() });
    ...
    public static void addChemDyeCrafting(){
        ...
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.SILVER, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.GRAY),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.WHITE),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.ORANGE, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.RED),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.YELLOW),   DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.LIME, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.GREEN),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.WHITE),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.CYAN, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.BLUE),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.GREEN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.PURPLE, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.RED),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.BLUE),     DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.BROWN, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.ORANGE),	DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.BLACK),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.MAGENTA, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.PINK),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.PURPLE),   DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.LIGHTBLUE, 3),	new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.BLUE),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.WHITE),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.PINK, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.RED),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.WHITE),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
        addShapelessAuto(DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.GREEN, 3),		new Object[] { DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.BLUE),		DictFrame.fromOne(ModItems.chemical_dye, EnumChemDye.YELLOW),   DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN),    DictFrame.fromOne(ModItems.oil_tar, ItemEnums.EnumTarType.PARAFFIN) });
	...
	public static void addCrafting() {
		...
		addRecipeAuto(new ItemStack(ModBlocks.watz_pump, 1), new Object[]{"MPM", "PCP", "PSP", 'M', ModItems.motor_desh, 'P', ANY_RESISTANTALLOY.plateCast(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP_BISMOID), 'S', ModItems.pipes_steel});
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_nuke_furnace_off, 1), new Object[] { "SSS", "LFL", "CCC", 'S', STEEL.plate(), 'C', CU.plateWelded(), 'L', PB.plate(), 'F', Item.getItemFromBlock(Blocks.FURNACE) });
		addRecipeAuto(new ItemStack(ModBlocks.machine_electric_furnace_off, 1), new Object[] { "BBB", "WFW", "RRR", 'B', BE.ingot(), 'R', ModItems.coil_tungsten, 'W', CU.plateCast(), 'F', Item.getItemFromBlock(Blocks.FURNACE) });
		addRecipeAuto(new ItemStack(ModBlocks.machine_arc_furnace_off, 1), new Object[] { "ITI", "PFP", "ITI", 'I', W.ingot(), 'T', ModBlocks.machine_transformer, 'P', CU.plateCast(), 'F', Blocks.FURNACE });
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_boiler_off, 1), new Object[] { "SPS", "TFT", "SPS", 'S', STEEL.ingot(), 'P', CU.plateWelded(), 'T', ModItems.tank_steel, 'F', Blocks.FURNACE });
		addRecipeAuto(new ItemStack(ModBlocks.machine_boiler_electric_off, 1), new Object[] { "SPS", "TFT", "SPS", 'S', DESH.ingot(), 'P', CU.plateWelded(), 'T', ModItems.tank_steel, 'F', ModBlocks.machine_electric_furnace_off });
		addRecipeAuto(new ItemStack(ModBlocks.machine_boiler_rtg_off, 1), new Object[] { "SPS", "TFT", "SPS", 'S', STAR.ingot(), 'P', CU.plateWelded(), 'T', ModItems.tank_steel, 'F', ModBlocks.machine_rtg_furnace_off });
        ...
        addRecipeAuto(new ItemStack(ModBlocks.press_preheater, 1), new Object[] { "INI", "ILI", "INI", 'I', IRON.ingot(), 'N', Blocks.NETHERRACK, 'L', Items.LAVA_BUCKET });
		...
		addShapelessAuto(new ItemStack(ModItems.overfuse, 1), new Object[] { ModItems.screwdriver, NP237.dust(), I.dust(), TH232.dust(), AT.dust(), ND.dust(), CU.plateWelded(), ModItems.singularity_spark, CS.dust() });
		addShapelessAuto(new ItemStack(ModItems.overfuse, 1), new Object[] { ModItems.screwdriver, SR.dust(), BR.dust(), CO.dust(), TS.dust(), NB.dust(), CU.plateWelded(), ModItems.singularity_spark, CE.dust() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.fwatz_cooler, 2), new Object[] { "III", "IPI", "III", 'I', SBD.ingot(), 'P', ModItems.thermo_unit_endo });
		addRecipeAuto(new ItemStack(ModBlocks.fwatz_tank, 1), new Object[] { "CGC", "GGG", "CGC", 'C', CMB.plate(), 'G', KEY_ANYPANE });
		addRecipeAuto(new ItemStack(ModBlocks.fwatz_scaffold, 2), new Object[] { "IPI", "P P", "IPI", 'I', W.ingot(), 'P', getReflector() });
		addRecipeAuto(new ItemStack(ModBlocks.fwatz_conductor, 2), new Object[] { "IPI", "PFP", "IPI", 'I', TI.plate(), 'P', ModItems.coil_magnetized_tungsten, 'F', ModBlocks.hadron_coil_neodymium });
        ...
        addRecipeAuto(new ItemStack(ModBlocks.brick_dungeon, 4), new Object[] { "CC", "CC", 'C', ModBlocks.brick_dungeon_flat });
        addRecipeAuto(new ItemStack(ModBlocks.brick_dungeon_tile, 4), new Object[] { "CC", "CC", 'C', ModBlocks.brick_dungeon });
        addRecipeAuto(new ItemStack(ModBlocks.brick_dungeon_circle, 1), new Object[] { "CCC", "C C", "CCC", 'C', ModBlocks.brick_dungeon_tile });
...
//		addRecipeAuto(new ItemStack(ModItems.containment_box, 1), new Object[] { "LLL", "LCL", "LLL", 'L', PB.plate(), 'C', Blocks.CHEST });
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_geo, 1), new Object[] { "ITI", "PCP", "ITI", 'I', DURA.ingot(), 'T', ModItems.thermo_element, 'P', CU.plateWelded(), 'C', ModBlocks.red_wire_coated });
		...
		addRecipeAuto(new ItemStack(ModItems.mp_thruster_15_balefire_large_rad, 1), new Object[] { "CCC", "CTC", "CCC", 'C', CU.plateWelded(), 'T', ModItems.mp_thruster_15_balefire_large });
		...
		addRecipeAuto(new ItemStack(ModBlocks.det_n2, 1), new Object[] { "PDT", "DDD", "PDP", 'P', STEEL.plateCast(), 'D', ModItems.n2_charge, 'T', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BASIC) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.det_bale, 1), new Object[] { "DAP", "DCD", "DBD", 'D', TI.plateCast(), 'A', ModItems.powder_power, 'B', ModItems.powder_magic, 'C', ModItems.egg_balefire, 'P', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CONTROLLER_ADVANCED) });
	...
	public static void reg3(){
		...
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_alloy, 1), new Object[] { "WW", "WW", 'W', new ItemStack(ModItems.wire_dense, 1, MAT_ALLOY.id) });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_gold, 1), new Object[] { "WG", "GW", 'W', new ItemStack(ModItems.wire_dense, 1, MAT_ALLOY.id), 'G', new ItemStack(ModItems.wire_dense, 1, MAT_GOLD.id) });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_neodymium, 1), new Object[] { "WG", "GW", 'W', new ItemStack(ModItems.wire_dense, 1, MAT_NEODYMIUM.id), 'G', new ItemStack(ModItems.wire_dense, 1, MAT_GOLD.id) });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_magtung, 1), new Object[] { "WG", "GW", 'W', new ItemStack(ModItems.wire_dense, 1, MAT_MAGTUNG.id), 'G', new ItemStack(ModItems.wire_dense, 1, MAT_BSCCO.id) });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_schrabidium, 1), new Object[] { "WG", "GW", 'W', new ItemStack(ModItems.wire_dense, 1, MAT_MAGTUNG.id), 'G', new ItemStack(ModItems.wire_dense, 1, MAT_SCHRABIDIUM.id) });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_schrabidate, 1), new Object[] { "WG", "GW", 'W', new ItemStack(ModItems.wire_dense, 1, MAT_SCHRABIDATE.id), 'G', new ItemStack(ModItems.wire_dense, 1, MAT_SCHRABIDIUM.id) });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_starmetal, 1), new Object[] { "WG", "GW", 'W', new ItemStack(ModItems.wire_dense, 1, MAT_SCHRABIDATE.id), 'G', new ItemStack(ModItems.wire_dense, 1, MAT_STAR.id) });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_chlorophyte, 1), new Object[] { "WG", "GW", 'W', new ItemStack(ModItems.wire_dense, 1, MAT_TUNGSTEN.id), 'G', ModItems.powder_chlorophyte });
		...
		addRecipeAuto(new ItemStack(ModItems.pile_rod_plutonium, 1), new Object[] { " U ", "PUP", " U ", 'P', IRON.plate(), 'U', PU.billet() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_fraction_tower), new Object[] { "S", "G", "S", 'S', STEEL.plateWelded(), 'G', ModBlocks.steel_grate });
		...
		addRecipeAuto(new ItemStack(ModItems.heart_fab, 1), new Object[] { "GHG", "MCM", "GHG", 'G', PO210.billet(), 'H', ModItems.heart_booster, 'M', ModItems.ingot_euphemium, 'C', ModItems.coin_worm });
        ...
        addRecipeAuto(new ItemStack(ModItems.starmetal_shield, 1), new Object[] { "IAI", "III", " I ", 'I', STAR.ingot(), 'A', CO.ingot() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.hadron_core, 1), new Object[] { "CCC", "DSD", "CCC", 'C', ModBlocks.hadron_coil_alloy, 'D', ModBlocks.hadron_diode, 'S', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CONTROLLER_QUANTUM) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.hadron_plating, 3), new Object[] { "WW", "WW", 'W', STEEL.plateCast() });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_plating, 12), new Object[] { "WW", "WW", 'W', STEEL.plateWelded() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.hadron_access, 1), new Object[] { "IGI", "CRC", "IPI", 'I', ModItems.plate_polymer, 'G', KEY_ANYPANE, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ATOMIC_CLOCK), 'R', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CONTROLLER_ADVANCED), 'P', ModBlocks.hadron_plating_blue });
		...
		addRecipeAuto(new ItemStack(ModItems.assembly_nuke, 1), new Object[] { " WP", "SEC", " WP", 'W', new ItemStack(ModItems.wire, 1, MAT_ALUMINIUM.id), 'P', STEEL.plate(), 'S', ModItems.hull_small_steel, 'E', ANY_HIGHEXPLOSIVE.ingot(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CONTROLLER) })	;
	...
	public static void addPellet(DictFrame mat, EnumWatzType num) {
		addRecipeAuto(new ItemStack(ModItems.watz_pellet, 1, num.ordinal()), new Object[] { " I ", "IGI", " I ", 'I', mat.ingot(), 'G', GRAPHITE.ingot() });
	}
	...
	public static void addBillet(Item billet, Item nugget, DictFrame mat){
		addRecipeAuto(new ItemStack(billet), new Object[] { "###", "###", '#', mat.nugget() });
		addShapelessAuto(new ItemStack(nugget, 6), new Object[] { mat.billet() });
	}

	public static void addBilletByIngot(Item billet, Item ingot, DictFrame mat){
		addShapelessAuto(new ItemStack(billet, 3), new Object[] { mat.ingot(), mat.ingot() });
		addShapelessAuto(new ItemStack(ingot, 2), new Object[] { mat.billet(), mat.billet(), mat.billet() });
	}
